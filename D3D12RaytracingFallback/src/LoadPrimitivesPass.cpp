...
namespace FallbackLayer
{
        ...
        D3D12_GPU_VIRTUAL_ADDRESS cachedSortBuffer)
    {
        ...
        for (UINT elementIndex = 0; elementIndex < buildDesc.Inputs.NumDescs; elementIndex++) 
        {
            const D3D12_RAYTRACING_GEOMETRY_DESC &geometryDesc = GetGeometryDesc(buildDesc.Inputs, elementIndex);
