...
// Pulled from: https://github.com/LouisBavoil/ThreadGroupIDSwizzling/blob/master/ThreadGroupTilingX.hlsl
...
uint2 ThreadGroupTilingX(
	...
	inout uint2 groupId			// SV_GroupID
)
{
	...
	groupId.xy = SwizzledvThreadGroupID;
